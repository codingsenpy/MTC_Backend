  ...
  return async (req, res, next) => {
    ...
    res.json = function(data) {
      ...
      if (statusCode < 400 && req.user && data) {
        ...
        console.log(`Activity Logger: Processing ${action} for ${targetType}`, {
          statusCode,
          hasUser: !!req.user,
          hasData: !!data,
        ...
        console.log(`Activity Logger: Extracted info - ID: ${targetId}, Name: ${targetName}`);
        ...
        if (targetId && targetId !== 'Unknown') {
          ...
          console.log(`Activity Logger: Skipping log - missing targetId or targetName`);
        }
      } else {
        console.log(`Activity Logger: Skipping log - Status: ${statusCode}, HasUser: ${!!req.user}, HasData: ${!!data}`);
      }
