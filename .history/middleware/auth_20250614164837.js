...
import Supervisor from '../models/Supervisor.js'; // Assuming you have a Supervisor model
...
export const auth = async (req, res, next) => {
  try {
    ...
    if (decoded.role === 'admin') {
      ...
      user = await Supervisor.findById(decoded.id).select('-password'); // Assuming supervisors are also admins
    }
